...
module.exports = {
    ...
    "test: import instance using fromJSON": function () {
        var JSONwithundo = "{\"$redoStack\":[],\"$undoStack\":[[{\"start\":{\"row\":0,\"column\":0},\"end\":{\"row\":0,\"column\":1},\"action\":\"insert\",\"lines\":[\"j\"],\"id\":1}]]}";
        var JSONwithredo = "{\"$redoStack\":[[{\"start\":{\"row\":0,\"column\":0},\"end\":{\"row\":0,\"column\":1},\"action\":\"insert\",\"lines\":[\"s\"],\"id\":2}]],\"$undoStack\":[]}";
        var JSONwithboth = "{\"$redoStack\":[[{\"start\":{\"row\":0,\"column\":0},\"end\":{\"row\":0,\"column\":1},\"action\":\"insert\",\"lines\":[\"s\"],\"id\":2}]],\"$undoStack\":[[{\"start\":{\"row\":0,\"column\":0},\"end\":{\"row\":0,\"column\":1},\"action\":\"insert\",\"lines\":[\"j\"],\"id\":1}]]}";
        var JSONwithnone = "{\"$redoStack\":[],\"$undoStack\":[]}";
        var state = JSON.parse(JSONwithundo);
