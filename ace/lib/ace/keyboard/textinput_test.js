define(function(require, exports, module){/*global CustomEvent*/
...
var MouseEvent = function (type, opts) {
    ...
    e.initMouseEvent("mouse" + type, true, true, window, opts.detail, opts.x, opts.y, opts.x, opts.y, opts.ctrl, opts.alt, opts.shift, opts.meta, opts.button || 0, opts.relatedTarget);
    return e;
};
...
module.exports = {
    ...
    "test: text input aria label without extra label set": function () {
        ...
        var text = editor.container.querySelector(".ace_text-input");
