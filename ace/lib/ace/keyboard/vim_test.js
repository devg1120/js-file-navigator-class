define(function(require, exports, module){var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
...
function eqCursorPos(a, b) {
    if (a.line != b.line || a.ch != b.ch)
        throw failure("Expected cursor position " +
            JSON.stringify([a.line, a.ch]) +
            " to be equal to " +
            JSON.stringify([b.line, b.ch]), eqCursorPos);
}
...
function is(a) {
    if (!a)
        throw failure("Expected " + a + " to be truthy", is);
}
...
function testVim(name, run, opts, expectedFail) {
    ...
    return test('vim_' + name, function (done) {
        return __awaiter(this, void 0, void 0, function () {
            var place, cm, vim, helpers, successful;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        place = document.createElement("testground");
                        place.style.visibility = "visible";
                        cm = CodeMirror(place, vimOpts);
                        vim = CodeMirror.Vim.maybeInitVimState_(cm);
                    ...
                    case 1:
                        _a.trys.push([1, , 3, 4]);
                        return [4 /*yield*/, run(cm, vim, helpers)];
                    case 2:
                        _a.sent();
                        successful = true;
                        return [3 /*break*/, 4];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            modeHist.length = 0;
                            helpers.doKeys(key);
                            if (!(key == '<C-c>' && !isOldCodeMirror)) return [3 /*break*/, 2];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    test('<C-v>', 'visual:blockwise');
                    test('v', 'visual');
                    return [4 /*yield*/, test('<C-c>', 'normal')];
                case 1:
                    _a.sent();
                    test('a', 'insert');
                    test('<Esc>', 'normal');
...
testVim('page_motions', function (cm, vim, helpers) {
    var value = "x".repeat(200).split("").map(function (_, i) { return i; }).join("\n");
    cm.setValue(value);
    cm.refresh();
    var lines = 10;
...
!isOldCodeMirror && testVim('<C-c>copy', function (cm, vim, helpers) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
//
var dvorakLangmap = "'q,\\,w,.e,pr,yt,fy,gu,ci,ro,lp,/[,=],aa,os,ed,uf,ig,dh,hj,tk,nl,s\\;,-',\\;z,qx,jc,kv,xb,bn,mm,w\\,,v.,z/,[-,]=,\"Q,<W,>E,PR,YT,FY,GU,CI,RO,LP,?{,+},AA,OS,ED,UF,IG,DH,HJ,TK,NL,S:,_\",:Z,QX,JC,KV,XB,BN,MM,W<,V>,Z?";
...
testVim('langmap_hh', function (cm, vim, helpers) {
    CodeMirror.Vim.langmap(dvorakLangmap);
    var startPos = word1.end;
    var endPos = offsetCursor(word1.end, 0, -2);
    cm.setCursor(startPos);
    helpers.doKeys('d', 'd');
    helpers.assertCursorAt(endPos);
});
...
testVim('langmap_qqddq@q', function (cm, vim, helpers) {
    CodeMirror.Vim.langmap(dvorakLangmap);
    cm.setCursor(0, 3);
    var expectedBuffer = cm.getRange(new Pos(1, 0), new Pos(2, 0));
    var expectedLineCount = cm.lineCount() - 2;
    helpers.doKeys('\'\'', 'e', 'e', '\'', '@\'');
    eq(expectedLineCount, cm.lineCount());
    var register = helpers.getRegisterController().getRegister();
