define(function(require, exports, module){var __values = (this && this.__values) || function(o) {
...
module.exports = {
    ...
    "test: highlight indent guide": function () {
        editor.session.setValue("function Test() {\n" + "    function Inner() {\n" + "        \n" + "        \n" + "    }\n" + "}");
    ...
    "test: scroll cursor into view": function () {
        ...
        editor.session.setValue("".concat(X(10), "\n").concat(X(1000), "}"));
        ...
        var leftBoundPixelPos = editor.renderer.$cursorLayer.getPixelPosition({ row: 0, column: 8 }).left;
        var rightBoundPixelPos = editor.renderer.$cursorLayer.getPixelPosition({ row: 0, column: 9 }).left;
        assert.ok(scrollDelta >= leftBoundPixelPos && scrollDelta < rightBoundPixelPos, "Expected content to have been scrolled two characters beyond the cursor");
    },
